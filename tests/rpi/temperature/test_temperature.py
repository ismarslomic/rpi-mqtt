...
from rpi.temperature.sensor import TemperatureSensor
...
@patch("rpi.temperature.sensor.subprocess.run")
...
@patch("rpi.temperature.sensor.subprocess.run", side_effect=FileNotFoundError("vcgencmd not found"))
