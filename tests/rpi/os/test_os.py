...
from rpi.os.sensor import AvailableUpdatesSensor, BootTimeSensor, OsKernelSensor, OsReleaseSensor
from rpi.types import SensorNotAvailableException


# Tests for OS Kernel sensor
@patch("rpi.os.sensor.subprocess.run")
...
@patch("rpi.os.sensor.subprocess.run", side_effect=FileNotFoundError("uname not found"))
...
@patch("rpi.os.sensor.APT_AVAILABLE", False)
